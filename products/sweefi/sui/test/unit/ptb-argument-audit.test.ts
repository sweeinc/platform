...
import { buildCreateUptoDepositTx, buildExpireUptoTx, buildSettleUptoTx } from '../../src/ptb/upto';
...
describe('PTB Argument Ordering Audit', () => {
  ...
  describe('escrow.move', () => {
    it('buildCreateEscrowTx → escrow::create<T>(Coin<T>, address, address, u64, u64, address, vector<u8>, &ProtocolState, &Clock)', () => {
      ...
      const tx = buildCreateEscrowTx(config, {
        ...
        arbiter: ADDR3,
        depositAmount: 1000000n,
        deadlineMs: BigInt(Date.now() + 86400000),
        feeMicroPercent: 5000,
        feeRecipient: ADDR4,
      });
      expect(tx).toBeInstanceOf(Transaction);
  ...
  describe('prepaid.move', () => {
    ...
    it('buildDepositWithReceiptsTx → prepaid::deposit_with_receipts<T>(..., vector<u8>, u64, &ProtocolState, &Clock)', () => {
      ...
      const tx = buildDepositWithReceiptsTx(config, {
        ...
        amount: 1000000n,
        ratePerCall: 1000n,
        withdrawalDelayMs: 86400000n,
        feeMicroPercent: 5000,
        feeRecipient: ADDR3,
        providerPubkey: pubkey,
        disputeWindowMs: 60000n,
      });
      expect(tx).toBeInstanceOf(Transaction);
    });
    ...
    it('buildDisputeClaimTx → prepaid::dispute_claim<T>(&mut PrepaidBalance<T>, address, u64, u64, vector<u8>, vector<u8>, &Clock)', () => {
      ...
      const tx = buildDisputeClaimTx(config, {
        ...
        receiptCallNumber: 50n,
        receiptTimestampMs: BigInt(Date.now()),
  ...
  describe('upto_deposit.move', () => {
    ...
    it('buildCreateUptoDepositTx rejects ceiling > maxAmount', () => {
      expect(() =>
        buildCreateUptoDepositTx(config, {
          coinType: SUI_TYPE,
          sender: ADDR1,
          recipient: ADDR2,
          maxAmount: 5000000n,
          settlementCeiling: 6000000n,
          settlementDeadlineMs: BigInt(Date.now() + 3600000),
          feeMicroPercent: 5000,
          feeRecipient: ADDR3,
        }),
    ...
    it('buildCreateUptoDepositTx requires protocolStateId', () => {
      expect(() =>
        buildCreateUptoDepositTx(configNoState, {
          coinType: SUI_TYPE,
          sender: ADDR1,
          recipient: ADDR2,
          maxAmount: 5000000n,
  ...
  describe('protocolStateId requirement', () => {
    const pauseGuardedBuilders = [
      {
        name: 'buildCreateStreamTx',
        fn: () =>
          buildCreateStreamTx(configNoState, {
            coinType: SUI_TYPE,
            sender: ADDR1,
            recipient: ADDR2,
            depositAmount: 1000000n,
      ...
      {
        name: 'buildCreateStreamWithTimeoutTx',
        fn: () =>
          buildCreateStreamWithTimeoutTx(configNoState, {
            coinType: SUI_TYPE,
            sender: ADDR1,
            recipient: ADDR2,
            depositAmount: 1000000n,
      ...
      {
        name: 'buildTopUpTx (stream)',
        fn: () =>
          buildTopUpTx(configNoState, {
            coinType: SUI_TYPE,
            meterId: OBJ1,
            sender: ADDR1,
            depositAmount: 1000000n,
      ...
      {
        name: 'buildCreateEscrowTx',
        fn: () =>
          buildCreateEscrowTx(configNoState, {
            coinType: SUI_TYPE,
            sender: ADDR1,
            seller: ADDR2,
            arbiter: ADDR3,
      ...
      {
        name: 'buildDepositTx (prepaid)',
        fn: () =>
          buildDepositTx(configNoState, {
            coinType: SUI_TYPE,
            sender: ADDR1,
            provider: ADDR2,
            amount: 1000000n,
      ...
      {
        name: 'buildPrepaidTopUpTx',
        fn: () =>
          buildPrepaidTopUpTx(configNoState, {
            coinType: SUI_TYPE,
            balanceId: OBJ1,
            sender: ADDR1,
            amount: 1000000n,
      ...
      {
        name: 'buildAdminPauseTx',
        fn: () =>
          buildAdminPauseTx(configNoState, {
            adminCapId: OBJ1,
            sender: ADDR1,
          }),
      },
      {
        name: 'buildAdminUnpauseTx',
        fn: () =>
          buildAdminUnpauseTx(configNoState, {
            adminCapId: OBJ1,
            sender: ADDR1,
          }),
      },
      {
        name: 'buildBurnAdminCapTx',
        fn: () =>
          buildBurnAdminCapTx(configNoState, {
            adminCapId: OBJ1,
            sender: ADDR1,
          }),
      },
      {
        name: 'buildAutoUnpauseTx',
        fn: () =>
          buildAutoUnpauseTx(configNoState, {
            sender: ADDR1,
          }),
      },
    ];
