...
import { MandateLevel } from '../ptb/agent-mandate.js';
...
export class AgentMandateContract {
  ...
  create =
    (params: CreateAgentMandateParams): ((tx: Transaction) => void) =>
    (tx: Transaction) => {
  ...
  pay =
    (params: AgentMandatedPayParams): ((tx: Transaction) => void) =>
    (tx: Transaction) => {
  ...
  upgradeLevel =
    (params: UpgradeMandateLevelParams): ((tx: Transaction) => void) =>
    (tx: Transaction) => {
      tx.moveCall({
  ...
  updateCaps =
    (params: UpdateMandateCapsParams): ((tx: Transaction) => void) =>
    (tx: Transaction) => {
      tx.moveCall({
