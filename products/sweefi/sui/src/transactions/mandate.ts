...
export class MandateContract {
  ...
  create =
    (params: CreateMandateParams): ((tx: Transaction) => void) =>
    (tx: Transaction) => {
      tx.moveCall({
  ...
  mandatedPay =
    (params: MandatedPayParams): ((tx: Transaction) => void) =>
    (tx: Transaction) => {
  ...
  revoke =
    (params: RevokeMandateParams): ((tx: Transaction) => void) =>
    (tx: Transaction) => {
      tx.moveCall({
  ...
  createRegistry =
    (_params: CreateRegistryParams): ((tx: Transaction) => void) =>
    (tx: Transaction) => {
      tx.moveCall({
