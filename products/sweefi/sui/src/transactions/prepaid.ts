...
export class PrepaidContract {
  ...
  deposit =
    (params: PrepaidDepositParams): ((tx: Transaction) => void) =>
    (tx: Transaction) => {
  ...
  depositWithReceipts =
    (params: PrepaidDepositWithReceiptsParams): ((tx: Transaction) => void) =>
    (tx: Transaction) => {
  ...
  claim =
    (params: PrepaidClaimParams): ((tx: Transaction) => void) =>
    (tx: Transaction) => {
      tx.moveCall({
  ...
  requestWithdrawal =
    (params: PrepaidOpParams): ((tx: Transaction) => void) =>
    (tx: Transaction) => {
      tx.moveCall({
        target: `${this.#config.packageId}::prepaid::request_withdrawal`,
        typeArguments: [params.coinType],
        arguments: [tx.object(params.balanceId), tx.object(this.#config.SUI_CLOCK)],
      });
    };
  ...
  topUp =
    (params: PrepaidTopUpParams): ((tx: Transaction) => void) =>
    (tx: Transaction) => {
  ...
  finalizeClaim =
    (params: PrepaidFinalizeClaimParams): ((tx: Transaction) => void) =>
    (tx: Transaction) => {
      tx.moveCall({
  ...
  disputeClaim =
    (params: PrepaidDisputeClaimParams): ((tx: Transaction) => void) =>
    (tx: Transaction) => {
      tx.moveCall({
  ...
  withdrawDisputed =
    (params: PrepaidWithdrawDisputedParams): ((tx: Transaction) => void) =>
    (tx: Transaction) => {
      tx.moveCall({
