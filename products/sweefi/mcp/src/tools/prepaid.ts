  ...
  server.registerTool(
    'sweefi_prepaid_deposit',
    {
      ...
      inputSchema: {
        ...
        maxCalls: z.string().optional().describe('Maximum total calls. Omit for unlimited.'),
        withdrawalDelayMs: z
          .string()
          .describe(
            'Grace period in ms before withdrawal completes. Min 60000 (1 min), max 604800000 (7 days).',
          ),
        ...
        feeMicroPercent: z
          ...
          .optional()
          .describe(
            'Fee in micro-percent (0-1000000, where 1000000 = 100%) charged on claims. Default 0.',
          ),
    ...
    'sweefi_prepaid_claim',
    {
      ...
      inputSchema: {
        ...
        cumulativeCallCount: z
          .string()
          .describe(
            'Total cumulative calls served (not delta). Move computes the delta from last claim.',
          ),
