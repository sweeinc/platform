...
export async function buildCreatePrepaidIx(
  ...
  offset += 8;
  argsBuffer.writeBigUInt64LE(params.ratePerCall, offset);
  offset += 8;
  argsBuffer.writeBigUInt64LE(params.maxCalls ?? 0n, offset);
  offset += 8;
  argsBuffer.writeBigInt64LE(params.withdrawalDelay ?? BigInt(MIN_WITHDRAWAL_DELAY), offset);
  offset += 8;
